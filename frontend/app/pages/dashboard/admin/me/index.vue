<template>
  <div class="space-y-6 dark:text-white max-w-4xl">
    <h1 class="text-3xl font-bold">O Meu Perfil (Administrador)</h1>
...
// ---- MUDANÇA AQUI (Novo estado para o toggle) ----
...
// ---- MUDANÇA AQUI (Nova função de Cancelar) ----
...
async function handleChangePassword() {
  ...
  try {
    ...
    // ---- MUDANÇA AQUI (Chamar a função de reset) ----
...
/* ---- MUDANÇA AQUI (Novo estilo para o botão 'Cancelar') ---- */
